...
class FavoriteImagesActivity : DaggerAppCompatActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil
            .setContentView(this, R.layout.activity_images_of_request)
        ...
        val username = intent.getStringExtra(EXTRA_REPLY)!!
        imagesViewModel = injectViewModel(viewModelFactory)
        imagesViewModel.getFavoriteImages(username)
        ...
        return ItemTouchHelper(
            object : ItemTouchHelper.SimpleCallback(
                ...
                override fun onSwiped(
                    ...
                    Toast.makeText(this@FavoriteImagesActivity, "Deleting image", Toast.LENGTH_LONG)
                        .show()
